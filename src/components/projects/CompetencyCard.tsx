/**
 * CompetencyCard — one of four "what I deliver as IT Manager" cards.
 *
 ...
 *   example" line that anchors the abstract competency to a concrete
 *   shipped piece of work. Composing two slightly-different cards is
 *   cleaner than overloading one with conditional flags.
 *
 * Server-renderable:
 ...
 *  - **Optional prop** — `example?: string`. The `?` makes it optional; if
 *    callers omit it, the "Recent" line is hidden. Optional props are how
 *    we keep components flexible without forcing every caller to pass
 *    every field.
 ...
 *    be rendered as a literal `<icon>` HTML tag, not React component).
